    ...
    <Layout absolute="true">
      ...
      <section className="flex flex-col mb-4 md:mb-16">
        ...
        <div className="flex flex-col lg:max-w-4xl lg:m-auto">
          <h2 className="mt-4 mb-4 text-wayblue">What We Believe</h2>
          ...
          <p>
            ...
            first importance; it is reformed because we believe God is sovereign
            to save; and it is charismatic because we believe in the
            continuation of all spiritual gifts listed in the New Testament.
          </p>
          <h3 className="text-xl mb-4">The Scriptures</h3>
          <p>
            We accept the Bible (39 books of the Old Testament and the 27 books
            of the New Testament) as the written Word of God. We believe the
            entire scriptures to be infallible (without mistakes) and inerrant
            (without error) meaning it is fully trustworthy. The Scriptures are
            the authoritative and normative rule and guide of all Christian
            life, practice and doctrine. They are totally sufficient and must
            not be added to, superseded or changed by later tradition,
            extra-biblical revelation or worldly wisdom. Every doctrinal
            formulation, whether of creed, confession or claims of personal
            revelation and prophecy, must be put to the test with the full
            counsel of God in Holy Scripture. Each book is to be interpreted
            according to its context and purpose and in reverent obedience to
            the Lord who speaks through it in living power. All believers are
          ...
          <p>
            ...
            mankind's redemption. He made all things for the praise of His glory
            and intends for humanity in particular, to live in fellowship with
            Himself.
          </p>
          <h3 className="text-xl mb-4">Jesus Christ</h3>

          <p>
            We believe that Jesus Christ is the only begotten Son of God who is
            the eternal Word made flesh. He was supernaturally conceived by the
            Holy Spirit, born of the virgin Mary and in his being He is both
            fully God and fully man. He was always with God and is God. By him
            and through Him and for him were all things created. He was before
            all things and in Him all things hold together by the word of His
            power. He is the image of the invisible God, the first-born over all
            creation and in Him dwells the fullness of the Godhead bodily. He is
            the only Saviour for the sins of the world having shed His blood and
            subsequently died on the cross. By His death in our place, He
            revealed the divine love and upheld divine justice, removing our
            guilt and reconciling us to God. Having redeemed us from sin, the
            third day He rose bodily from the grave for our justification,
            victorious over death and the powers of darkness and for a period of
            40 days appeared to over 500 witnesses performing many convincing
            proofs of His resurrection. He ascended into heaven where, at God's
            right hand he fulfils the roles of Prophet (as he speaks through his
            word), Priest (as he intercedes for his people) and King (as he
            rules overall). He is the Head of His body, the church, and should
            be adored, loved, served and obeyed by all as his inevitable return
            is waited for.
          </p>
          ...
          <p>
            ...
            righteousness and judgment. His ministry is crucial for the work of
            the gospel in the lives of both unbelievers and believers. Through
            the proclamation of the gospel He persuades individuals to repent of
            their sins and confess Jesus as Lord. The Holy Spirit unites
            believers to Jesus Christ in faith, brings about the new birth and
            dwells within the regenerate. He further is involved in sanctifying
            the believer as they become increasingly conformed to the image of
            Christ. He does this by using the means of grace provided for the
            believer in Bible study, prayer, fellowship & The Lord’s Supper. He
            has come to glorify the Son who in turn came to glorify the Father.
          ...
          <p>
            ...
            believe in Jesus Christ, thereby enabling them to exercise spiritual
            power in ministry and mission. The Holy Spirit desires to
            continually fill each believer with power to witness and imparts
            Spiritual gifts for the edification of the Body and the work of
            ministry in the world. All the gifts of the Holy Spirit at work in
            the church of the first century are available today and are to be
            earnestly desired and practiced in an orderly manner in accordance
            with the scriptures. The gifts are essential for the mission of the
          ...
          <p>
            ...
            schemes, is used in sovereign ways by God to execute his wise, good
            and holy purposes for His glory and the believer’s joy. He attacks
            God’s people through lies, temptations and spiritual warfare but his
            time is short. When Christ returns he shall banish Satan forever
            along with the whole evil realm and the unrepentant in the
            bottomless pit where he will be locked and sealed for all eternity.{" "}
          </p>

          <h3 className="text-xl mb-4">Humanity</h3>

          <p>
            We believe that God made humanity — male and female in His own image
            as the crown of creation that they might glorify Him through
            enjoying fellowship with Him. In doing this he also made the
            blueprint for heterosexual union as the biblical design for
            marriage. Tempted by the Devil, mankind rebelled against God. Being
            estranged from their Maker, yet responsible to Him, they became
            subject to divine wrath, inwardly depraved and apart from a special
            work of grace, utterly incapable of returning to God. This depravity
            is radical and pervasive. It extends to the mind, will and
            affections. Unregenerate men and women live under the dominion of
            sin and Satan, being described in the scriptures as “dead”. They are
            at enmity with God, hostile toward God, and hateful of God. Fallen,
            sinful people, whatever their character or attainments, are lost and
            without hope apart from salvation in Christ alone.
          </p>

          <h3 className="text-xl mb-4">The Gospel</h3>

          <p>
            We believe that the gospel is the good news of Jesus Christ who has
            lived the life that we could not have lived and died the death that
            we should have died and who rose again victoriously. Christ's
          ...
          <p>
            ...
            accompanied by repentance from sin. This is how sinful humanity can
            be “justified” (declared right in the courtroom of heaven before a
            Holy God) whereby the action of double imputation (credit to
            another’s account) takes place; our sin on Christ and his perfect
            righteousness on us.{" "}
          </p>

          <p>
            This response to the gospel is rooted and grounded in the free and
            unconditional election of God for His own pleasure and glory. Since
            we do not know God’s wise and sovereign decrees regarding the
            salvation of his people we are not called to speculate and
          ...
          <p>
            ...
            fellowship of Christ's Body. By the same Word and Spirit, He guides
            and preserves that new redeemed humanity. The church is not a
            religious institution or denomination. Rather, the Church universal
            is made up of those who have become genuine followers of Jesus
            Christ and have personally appropriated the gospel. The Church
            exists to worship and glorify God as Father, Son and Holy Spirit. It
            also exists to serve Him by faithfully doing His will in the earth.
            The ultimate mission of the Church is worship and the means by which
            this is accomplished is the making of disciples through the
            preaching and embracing of the gospel. Upon conversion, newly
            redeemed men and women are added to a local church in which they
            devote themselves to teaching, fellowship, the breaking of bread and
            prayer.{" "}
          </p>
          ...
          <p>
            ...
            teachers for the equipping of Christ's body that it might mature and
            grow. The gifts of apostle and prophet must be distinguished from
            the offices of apostle and prophet who spoke with infallibility as
            God’s progressive revelation in the formation of the scriptures was
            still in progress. The gift of apostle is seen in church planting
            and pioneer work and the gift of prophet is seen in those who by
            God’s grace speak words in season to build up individuals or the
            whole body via means of revelation/insight or appropriate
            application of scripture. All prophetic utterances are to be tested
            in accordance with the scriptures. Through the gift ministries, all
            members of the church are to be nurtured and equipped for the work
            of the ministry.
          </p>
          ...
          <p>
            ...
            gifts in His service in relation to one another and to the world. We
            therefore believe in the priesthood of all believers in
            ...
            decisions from within, including the appointment/affirmation of its
            leaders.
          </p>
          ...
          <p>
            ...
            spiritual direction of the church. They are gifted and set aside by
            the Holy Spirit, in recognition by the church to carry out their
            tasks. Deacons are those recognised by the church who lead and
            assist in the practical welfare and mercy ministry of both the
          ...
          <p>
            ...
            Lord’s work on the cross and be refreshed in their walk with him as
            they live their lives in a fallen world waiting for his return.
            Although the emblems used do not change in any shape or form or have
            any saving merit in them, the Lord’s Supper is a privileged means of
            grace for believers who partake of it.
          </p>

          <h3 className="text-xl mb-4">The Future State</h3>

          <p>
            We believe that the consummation of all things includes the future,
            physical, visible, personal and glorious return of Jesus Christ, the
            resurrection of the dead of both the just and the unjust and the
            translation of those alive in Christ at his coming. When Christ
            returns he will consummate his kingdom and usher in the new heavens
            and the new earth where his people will serve and enjoy him forever
            and those unrepentant will suffer eternal conscious punishment for
            their sins against a Holy God.
          </p>

          <p>
            These are the fundamentals of “eschatology” (study of last things).
            We promote people to have conviction and share their views regarding
            other issues such as Millennialism (the understanding of the
            “thousand years” in Revelation 20) and prophetic/apocalyptic
            passages in the scripture but discourage divisiveness over such
            issues; desiring to keep the bonds of peace and glory in what is
            clear - namely Christ is returning.
          </p>

          <h3 className="text-xl mb-4">Christian Behaviour</h3>

          <p>
            We believe every believer is to live as salt and light in the world
            that others may see our good deeds and glorify our father in heaven.
            It is expected that Christians are to live counter-cultural lives as
            an expression of how the Gospel has changed them.
          </p>
          ...
          <p>
            ...
            each believer as well as the command to not put a stumbling block in
            front of others.
          </p>

          <p>
            When Christian behaviour is compromising to the gospel and/or to the
            local church the necessary form of church discipline will be carried
            out.
          </p>
        </div>

        <div className="flex flex-col lg:max-w-4xl lg:m-auto">
          <h2 className="mt-8 mb-4 text-wayblue">What to Expect</h2>
          <p>
      ...
      <ul className="grid gap-4 xl:gap-8 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 pb-0">
        <li className="flex flex-col md:col-span-2 xl:col-span-1">
          <div className="flex flex-col flex-grow xl:items-start bg-dark p-6 pt-8 rounded">
        ...
        <li className="flex flex-col">
          <div className="flex flex-col flex-grow bg-dark p-6 pt-8 rounded">
